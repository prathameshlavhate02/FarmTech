...
<style>
    ...
    * {
    ...
    /* Unique Theme Colors */
    :root {
        --farmtech-gold: #FFD700;
        --farmtech-dark: #2C2C2C;
        --farmtech-light: #FAF3DD;
        --farmtech-border: #B8860B;
    }

    /* Print Button Styling */
    .print-btn {
        font-size: 22px;
        color: var(--farmtech-dark);
        background-color: var(--farmtech-gold);
        border: 2px solid var(--farmtech-dark);
        border-radius: 8px;
        padding: 12px 20px;
    ...
    .print-btn:hover {
        background-color: var(--farmtech-dark);
        color: var(--farmtech-gold);
        border-color: var(--farmtech-gold);
    }

    /* Bill Section Styling */
    #billSection {
        background-color: var(--farmtech-light);
        border: 2px dashed var(--farmtech-border);
        padding: 30px;
    ...
    #billSection hr {
        border: 1px solid var(--farmtech-border);
    }
    ...
    #billSection th,
    #billSection td {
        border: 1px solid var(--farmtech-dark);
        padding: 10px;
        text-align: center;
    }
...
<div class="container mt-2">
    ...
    <hr>
    <div class="float-right p-2" style="border-radius:5%;">
        <h4 style="font-family: sans-serif"><b>Grand total = Rs. <?php echo $grand_total; ?></b></h4>
        <h4 style="font-family: sans-serif"><b>Delivery Charges = Rs. <?php echo $delivery_charge; ?></b></h4>
        <h4 style="font-family: sans-serif"><b>Total Amount = Rs. <?php echo $total_amount; ?></b></h4>
    </div>
</div>
...
<div class="container mt-5">
    ...
    Generate & Print Bill <i class="fas fa-print"></i>
</button>
...
<div id="billSection" style="display:none;">
    <div style="padding:20px; font-family:'Georgia';">
        <h2 style="text-align:center;">Order Invoice</h2>
        <hr>
        <p><strong>Customer Phone:</strong> <?php echo $sess_phone_number; ?></p>
        <p><strong>Delivery Address:</strong> <?php echo $buyer_addr; ?></p>
        <table border="1" width="100%" cellspacing="0" cellpadding="10" style="margin-top:20px;">
            <thead>
                <tr>
                    <th>Sr No.</th>
                    <th>Product Name</th>
            ...
            <tbody>
                ...
                for ($j = 0; $j < count($allproducts); $j++) {
                    $product_id = $allproducts[$j];
                    $qty = $allqty[$j];
                    $total = $allsubtotal[$j];

                    $get_title = "select product_title from products where product_id='$product_id'";
                    $run_title = mysqli_query($con, $get_title);
                    $title_row = mysqli_fetch_assoc($run_title);
                    $product_title = $title_row['product_title'];
                    echo "<tr>
                            <td>" . ($j + 1) . "</td>
                            <td>$product_title</td>
                            <td>$qty</td>
        ...
        <br>
        <h4>Delivery Charges: Rs. <?php echo $delivery_charge; ?></h4>
        <h3><strong>Total Payable: Rs. <?php echo $total_amount; ?></strong></h3>
        <br><br>
        <p style="text-align:center;">Thank you for shopping with <strong>FarmTech</strong>!</p>
    </div>
</div>
<!-- Print Script -->
<script>
    function printBill() {
        var billContents = document.getElementById("billSection").innerHTML;
