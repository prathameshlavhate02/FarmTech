...
<table class="table">
    ...
    if (isset($_SESSION['phonenumber'])) {
        ...
        while ($p_price = mysqli_fetch_array($run_price)) {
            ...
            $qty = $p_price['qty']; // Get quantity from database
    ...
    ?>
                ...
                <tbody>
                    <tr>
                        ...
                        <td data-label="Quantity" style="padding-top:1.5%;padding-bottom:-2%">
                            <div class="d-flex justify-content-center" style="width:90%;padding-left:10%;">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="number" class="form-control" min="1" value='<?php echo $qty; ?>' name="qty" readonly>
                        ...
                        $subquery = "UPDATE cart SET subtotal = $subtotal WHERE product_id = $product_id AND phonenumber = '$sess_phone_number'";
                        mysqli_query($con, $subquery);
                        ?>

                        <td data-label="Subtotal" style="font-size:20px;"><?php echo $subtotal; ?></td>
                        <?php $total += $subtotal; ?>
                        <td data-label="Delete" style="font-size:20px;">
                            <a href="DeleteProductCart.php?id=<?php echo $product_id; ?>" id="Deletionlink">
