...
<?php
// Sample array of products saved for later (replace with DB fetch logic as needed)
$saveForLater = [
    [
        'seller' => 'ABHISHEK',
        'image' => 'fruit1.jpeg',
    ...
    <div class="text-left">
        <h2>Save For Later
            <div class="text-right">
                <button type="button" class="btn btn-warning border border-dark" style="margin-top:-5%">
                    <b>Delete all</b>
                </button>
            </div>
        </h2>
...
<div class="container">
    <div class="row">
        <?php foreach ($saveForLater as $product): ?>
            <div class="col col-12 col-sm-12 col-md-4 col-xl-4 col-lg-4">
                <div class="card pl-3 pr-3 pb-0 pt-2 mt-2">
                    <br>
                    <div>
                        <h3><b><img src="iconsmall.png"> <?= htmlspecialchars($product['seller']) ?></b>
                            <button class="cross" style="border-style:none;background-color:transparent;">
                                <i class="fas fa-times"></i>
                            </button>
                        </h3>
                    </div>
                    <img class="card-img-top" src="<?= htmlspecialchars($product['image']) ?>" alt="Card image">
                    <div class="card-body">
                        <h5 class="card-title"><?= htmlspecialchars($product['title']) ?></h5>
                        <p class="card-text">PRICE:-<?= htmlspecialchars($product['price']) ?></p>
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                                <span class="input-group-text bg-warning border-secondary" style="color:black">
                                    <b>Quantity</b>
                                </span>
                            </div>
                            <input type="number" class="form-control" aria-label="Quantity">
                        </div>
                        <a href="#" class="btn btn-warning border-secondary" style="color:black">
                            <b>Add to cart</b><img src="carticons.png">
                        </a>
                    </div>
                </div>
            </div>
